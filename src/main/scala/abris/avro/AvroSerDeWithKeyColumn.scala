...
import abris.avro.schemas.SchemasProcessor
import abris.avro.schemas.impl.{AvroToSparkProcessor, SparkToAvroProcessor}
import abris.avro.schemas.policy.SchemaRetentionPolicies.{RETAIN_ORIGINAL_SCHEMA, RETAIN_SELECTED_COLUMN_ONLY, SchemaRetentionPolicy}
import abris.avro.serde.{AvroDecoder, AvroToRowEncoderFactory}
...
/**
  ...
  * [[abris.avro.schemas.policy.SchemaRetentionPolicies]].
  *
  * IMPORTANT: This API was created in a separate file since it was added later and the refactoring of the previous one [[abris.avro.AvroSerDe]]
...
object AvroSerDeWithKeyColumn {
  ...
  implicit class StreamDeserializer(dsReader: DataStreamReader) extends AvroDecoder {
    ...
    /**
      ...
      *
      * Refer to the [[abris.avro.read.confluent.ScalaConfluentKafkaAvroDeserializer]] deserialize() method documentation to better understand how this
