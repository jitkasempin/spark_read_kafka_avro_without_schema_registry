...
import abris.avro.read.confluent.ScalaConfluentKafkaAvroDeserializer
...
import abris.avro.serde.AvroDecoder
/**
 * This object provides the main point of integration between applications and this library.
  *
  * It is STRONGLY recommended that users of this library understand the concept behind [[abris.avro.schemas.policy.SchemaRetentionPolicies]].
 */
object AvroSerDe {
