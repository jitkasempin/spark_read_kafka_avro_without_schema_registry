...
package abris.avro.schemas.policy

/**
  * This object contains options for schema retention during Avro/Spark conversions.
  *
  * When [[abris.avro.schemas.policy.SchemaRetentionPolicies.RETAIN_SELECTED_COLUMN_ONLY]] is used, the column
  * containing Avro data is extracted and the whole Dataframe schema becomes the Avro schema defining those data.
  *
  * When [[abris.avro.schemas.policy.SchemaRetentionPolicies.RETAIN_ORIGINAL_SCHEMA]] is used, the current
